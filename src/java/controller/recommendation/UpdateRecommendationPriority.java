...
@WebServlet("/updaterecommendationpriority")
public class UpdateRecommendationPriority extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        recommendationdao.updateRecommendationPriority(recommendationId, priority);
