    ...
    <body>
        ...
        <div class="is-sb">
            ...
            <div class="section" id="is-sb-sec-bgtj" collapse="false">
                ...
                <div class="label">Tutorials&nbsp;&nbsp;<i class="is-caret fas"></i></div>
                <% 
                    for(int i=0; i<allTutorials.size(); i++) {
                %>
                    <a class="element" href="/article/<%=allTutorials.get(i).getIdentifier()%>"><%=allTutorials.get(i).getTitle()%></a>
                <% 
                    }
                %>
            </div>
        ...
        <div class="is-container">
            ...
            <div class="is-content">
                ...
                <p>This example does not really do anything, other than showing you how to add the viewport meta element.
                    This example does not really do anything, other than showing you how to add the viewport meta element.</p>
            </div>
