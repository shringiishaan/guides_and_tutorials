...
<%
    ...
    if(topicIdString == null) {
        response.sendRedirect("/managetopictutoriallink?tid="+allTopics.get(0).getId());
        return;
    }
    else {
...
<html>
    <head>
        <title>Manage Topic-Tutorial Links | Computer Science and Programming Tutorials</title>
    ...
    <body>
                ...
                <div class="col-12 p-4 is-content">
                    <div class="row mb-4 mt-3">
                        <div class="col-12">
                            ...
                            <a class="btn btn-sm btn-secondary" href="/managetopictutoriallink">Topic-Tutorial</a>
                                    ...
                                    <select id="tid-select" name="tid" class="form-control" onchange="changeTopicIdSelection()">
                                        <% for(int i=0; i<allTopics.size(); i++) { %>
                                            <option value="<%=allTopics.get(i).getId()%>"
                                                    ...
                                                    ><%=allTopics.get(i).getTitle()%></option>
                                        <% } %>
                                    </select>
                                </div>  
                                <div class="col-lg-6">
                                    <%  tempTutorials = tutorialdao.getTutorialsByTopicIdAndStatus(currentTopic.getId(), null);
                                        for(int i=0; i<tempTutorials.size(); i++) { %>
                                            <div class="card card-body p-2 mb-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <form action="/updatetutorialpriority" method="GET" class="mt-3">
                                                            <div class="input-group">
        ...
        <script lang="text/javascript">
            function changeTopicIdSelection() {
                window.location.href = "/managetopictutoriallink?tid=" + $("#tid-select").val();
            }
        </script>
    </body>
</html>