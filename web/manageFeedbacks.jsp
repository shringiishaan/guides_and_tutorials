...
<%
    ...
    List<HashMap<String,String>> feedbacks = feedbackdao.getAllFeedbacks();
%>
<!DOCTYPE html>
<html>
    <head>
        <title>Manage Feedbacks | Computer Science and Programming Tutorials</title>
                ...
                <div class="col-12 p-4 is-content">
                    <div class="row mb-4 mt-3">
                        <div class="col-12">
                            ...
                            <a class="btn btn-sm btn-default is-btn-primary" href="/managefeedbacks">Feedbacks</a>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    %>
                                    <h6>Feedbacks (<%=feedbacks.size()%>)</h6>
                                    <hr />
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <% for(int i=0; i<feedbacks.size(); i++) { %>
                                                <tr>
                                                    <td>
                                                        <%=feedbacks.get(i).get("data")%>
                                                    </td>
                                                    <td>
                                                        <%=feedbacks.get(i).get("ownerKey")%>
                                                    </td>
                                                    <td>
                                                        <%=feedbacks.get(i).get("id")%>
                                                    </td>
                                                    <td>
                                                        <%=feedbacks.get(i).get("createTime")%>
                                                    </td>
                                                    <td>
                                                        <form action="/updatefeedbackstatus" method="POST">
                                                            <div class="input-group">
                                                                <input name="feedbackId" value="<%=feedbacks.get(i).get("id")%>" hidden="true" />
                                                                <input name="redirectURL" value="/managefeedbacks" hidden="true" />
                                                                <input type="text" name="status" class="form-control" value="<%=feedbacks.get(i).get("status")%>" />
