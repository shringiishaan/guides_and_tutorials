...
<html>
    <head>
        <title>The Computer Guide | New Tutorial</title>
        ...
        <div class="is-container">
            ...
            <div class="is-content">
                <center>
                    ...
                    %>
                    <form action="/NewTutorial" method="post">
                        <input type="text" name="title" 
                               <%
                                    if(session.getAttribute("tutorialFormTitle")!=null) {
                                        %> value="<%=session.getAttribute("tutorialFormTitle")%>"<%
                                        session.removeAttribute("tutorialFormTitle");
                                    }
                                    else {
