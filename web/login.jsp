...
<html>
    <head>
        <title>The Computer Guide | Login</title>
                ...
                <center>
                    ...
                    <form action="/login" method="post">
                        <input type="text" name="email" 
                               <%
                                    if(session.getAttribute("loginFormEmail")!=null) {
                                        %> value="<%=session.getAttribute("loginFormEmail")%>"<%
                        ...
                        <input type="submit" name="submit" value="Login" class="is-btn" />
                    </form>
                </center>
            </div>
